...
describe("The review Process", function() {
  ...
  describe("Receiving a valid application", function() {
    ...
    before(function(done) {
      ...
      sinon
        .stub(billing, "createSubscription")
        //.withArgs(Helpers.goodStripeArgs)
  ...
  describe("Valid application, failed billing", function() {
    ...
    before(function(done) {
      billing.createSubscription.restore();
      sinon.stub(billing, "createSubscription").yields("Card was declined", null);
      review = new ReviewProcess({
